...
import studentcode_122030080 as myCode
...
def recv_commands():
    ...
    while(1):
        ...
        if message[-1] == '\n':
            ...
            bitrate = myCode.student_entrypoint(jsonargs["Measured Bandwidth"], jsonargs["Previous Throughput"], jsonargs["Buffer Occupancy"], jsonargs["Available Bitrates"], jsonargs["Video Time"], jsonargs["Chunk"], jsonargs["Rebuffering Time"], jsonargs["Preferred Bitrate"])
