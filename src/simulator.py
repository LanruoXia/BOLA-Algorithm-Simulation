...
if __name__ == "__main__":
    ...
    while chunk:
        ...
        m_band = trace.get_current_timesegment(current_time)[1] # current bandwidth
        buf_occ = buffer.get_student_params() # {size, current, time}
        av_bitrates = prep_bitrates(manifest["Available_Bitrates"],chunk) # return a dict
        ...
        #? time needed to download the chunk to the buffer?
